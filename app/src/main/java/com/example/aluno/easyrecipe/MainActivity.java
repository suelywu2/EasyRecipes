...
import com.example.aluno.easyrecipe.Model.RecipeFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.cat_bolo_tortas) {
            ...
            recipe = connection.getRecipe("http://www.tudogostoso.com.br/receita/54118-bolo-de-aipim-facil.html");
        ...
        fragment = RecipeFragment.newInstance(bundle);
